...
export default function Navbar(params) {
    ...
    return (
        <div className=''>
            ...
            <nav className="navbar navbar-expand-lg secondtop d-flex ps-3 pe-3" id='secondtop'>
                            ...
                            <li className=" nav-item l1">
                                <div className='btn-group'>
                                    ...
                                    <ul className="dropdown-menu dropdown-menu-end ">
                                        <li><Link to={'/profile'} className="dropdown-item d-flex justify-content-between" href="#">Profile <UserOutlined /></Link></li>
                                        <li><a style={{ textAlign: '' }} className="dropdown-item d-flex justify-content-between" href="#">Add to listing <PlusOutlined /></a></li>
